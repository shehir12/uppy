...
},{"../package.json":102,"./Plugin":98,"./loggers":100,"./supportsUploadProgress":101,"@uppy/store-default":170,"@uppy/utils/lib/Translator":189,"@uppy/utils/lib/generateFileID":195,"@uppy/utils/lib/getFileNameAndExtension":202,"@uppy/utils/lib/getFileType":203,"@uppy/utils/lib/prettyBytes":215,"cuid":13,"lodash.throttle":46,"mime-match":48,"namespace-emitter":49}],100:[function(require,module,exports){
...
},{"@uppy/utils/lib/getTimeStamp":207}],101:[function(require,module,exports){
...
},{"./AddFiles":103,"./AddFilesPanel":104,"./FileCard":106,"./FileList":113,"./PickerPanelContent":115,"./PickerPanelTopBar":116,"@uppy/utils/lib/isTouchDevice":212,"classnames":9,"preact":53,"preact-css-transition-group":52}],106:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../../../utils/truncateString":126,"@uppy/utils/lib/prettyBytes":215,"preact":53}],109:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./getActiveOverlayEl":121,"@uppy/utils/lib//FOCUSABLE_ELEMENTS":188,"@uppy/utils/lib/toArray":219}],126:[function(require,module,exports){
/**
...
},{"../package.json":131,"@uppy/core":99,"@uppy/utils/lib/findDOMElement":194,"@uppy/utils/lib/toArray":219,"get-form-data":37}],131:[function(require,module,exports){
module.exports={
  "name": "@uppy/form",
...
},{"../package.json":151,"./AuthView":139,"./Browser":141,"./Loader":149,"@uppy/utils/lib/generateFileID":195,"@uppy/utils/lib/getFileType":203,"@uppy/utils/lib/isPreviewSupported":211,"preact":53}],151:[function(require,module,exports){
module.exports={
...
},{"@uppy/core":99,"@uppy/utils/lib/findDOMElement":194,"@uppy/utils/lib/toArray":219}],154:[function(require,module,exports){
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
},{"@uppy/dashboard":118,"@uppy/utils/lib/hasProperty":208}],157:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/dropbox":128,"@uppy/google-drive":133,"@uppy/instagram":137,"@uppy/transloadit":179,"@uppy/url":185,"@uppy/utils/lib/hasProperty":208,"@uppy/webcam":225}],158:[function(require,module,exports){
var Transloadit = require('@uppy/transloadit');
...
},{"./TransloaditResultsPlugin":155,"@uppy/transloadit":179,"@uppy/utils/lib/hasProperty":208}],159:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/core":99,"@uppy/utils/lib/hasProperty":208}],160:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"./AttachFileInputs":153,"./TransloaditFormResult":154,"./addDashboardPlugin":156,"./addProviders":157,"./addTransloaditPlugin":158,"@uppy/core":99,"@uppy/form":130,"@uppy/status-bar":168,"@uppy/utils/lib/findDOMElement":194,"@uppy/utils/lib/hasProperty":208}],162:[function(require,module,exports){
...
},{"./addTransloaditPlugin":158,"./createUppy":159,"@uppy/utils/lib/toArray":219}],165:[function(require,module,exports){
module.exports={
  "name": "@uppy/robodog",
...
},{"./StatusBarStates":167,"@uppy/utils/lib/prettyBytes":215,"@uppy/utils/lib/prettyETA":216,"classnames":9,"lodash.throttle":46,"preact":53}],167:[function(require,module,exports){
module.exports = {
  STATE_ERROR: 'error',
  STATE_WAITING: 'waiting',
  STATE_PREPROCESSING: 'preprocessing',
...
},{"../package.json":169,"./StatusBar":166,"./StatusBarStates":167,"@uppy/core":99,"@uppy/utils/lib/Translator":189,"@uppy/utils/lib/getBytesRemaining":196,"@uppy/utils/lib/getSpeed":206}],169:[function(require,module,exports){
module.exports={
...
},{"../package.json":174,"./image-orientations":172,"@uppy/core":99,"@uppy/utils/lib/dataURItoBlob":191,"@uppy/utils/lib/isObjectURL":210,"@uppy/utils/lib/isPreviewSupported":211,"exif-js":35}],174:[function(require,module,exports){
module.exports={
...
},{"./parseUrl":180,"@uppy/utils/lib/hasProperty":208,"component-emitter":11,"socket.io-client":58}],176:[function(require,module,exports){
/**
...
},{"../package.json":183,"@uppy/companion-client":95,"@uppy/core":99,"@uppy/utils/lib/emitSocketProgress":192,"@uppy/utils/lib/getSocketHost":205,"@uppy/utils/lib/limitPromises":213,"@uppy/utils/lib/settle":218,"tus-js-client":85}],183:[function(require,module,exports){
module.exports={
  "name": "@uppy/tus",
...
},{"@uppy/utils/lib/toArray":219}],187:[function(require,module,exports){
module.exports={
  "name": "@uppy/url",
...
},{"./hasProperty":208}],190:[function(require,module,exports){
...
},{"./isDOMElement":209}],194:[function(require,module,exports){
var isDOMElement = require('./isDOMElement');
/**
 * Find a DOM element.
 *
...
},{"./isDOMElement":209}],195:[function(require,module,exports){
/**
...
},{"./utils/fallbackApi":198,"./utils/webkitGetAsEntryApi/index":201}],198:[function(require,module,exports){
...
},{"../../toArray":219}],199:[function(require,module,exports){
/**
...
},{"../../../toArray":219,"./getFilesAndDirectoriesFromDirectory":199,"./getRelativePath":200}],202:[function(require,module,exports){
/**
...
},{"./getFileNameAndExtension":202,"./mimeTypes":214}],204:[function(require,module,exports){
...
},{"./RecordButton":223,"./SnapshotButton":224,"preact":53}],222:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./CameraIcon":220,"preact":53}],225:[function(require,module,exports){
var _class, _temp;
...
},{"../package.json":227,"./CameraIcon":220,"./CameraScreen":221,"./PermissionsScreen":222,"./supportsMediaRecorder":226,"@uppy/core":99,"@uppy/utils/lib/Translator":189,"@uppy/utils/lib/canvasToBlob":190,"@uppy/utils/lib/getFileTypeExtension":204,"preact":53}],226:[function(require,module,exports){
